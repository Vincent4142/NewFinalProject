		...
		<form action="/signup" style="border: 1px solid #ccc">
			<div class="container">
				...
				<label for="name"><b>暱稱</b></label> <input type="text"
					placeholder="10個以內的文字" name="name" required> 
				
				<label for="email"><b>Email(帳號)</b></label> <input type="text"
					placeholder="電子郵件信箱" name="email" required> 
					
				<label for="psw"><b>密碼</b></label> <input type="password"
					placeholder="8個以上包含半型英文和數字" name="psw" required> 
					
				<label for="psw-repeat"><b>再次輸入密碼</b></label> <input type="password"
					placeholder="8個以上包含半型英文和數字" name="psw-repeat" required>
				...
				<p>
					建立帳戶即表示您同意我們的 <a href="#" style="color: dodgerblue">條款及細則和私隱政策</a>.
				</p>
